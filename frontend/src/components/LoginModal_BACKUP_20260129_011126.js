...
const LoginModal = ({ isOpen, onClose }) => {
  ...
  const [loginMethod, setLoginMethod] = useState('password'); // 'password', 'phone' or 'email'
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(
        error.response?.data?.message || 
        (isEnglish ? '❌ Authentication failed. Please check your credentials.' : '❌ লগইন/রেজিস্ট্রেশন ব্যর্থ হয়েছে। তথ্য চেক করুন।')
      );
    } finally {
      setLoading(false);
    }
                ...
                <>
                  ...
                  {loginMethod === 'password' ? (
                    ...
                    <form onSubmit={handlePasswordSubmit} className="login-form">
                      {isRegister && (
                        <div className="login-input-group">
                          <label>{isEnglish ? 'Name' : 'নাম'}</label>
                          <input 
                            type="text" 
                      ...
                      <button type="submit" className="login-submit-btn" disabled={loading}>
                        {loading 
                          ...
                          : isRegister 
                            ? (isEnglish ? 'Register' : 'রেজিস্ট্রেশন করুন') 
                      ...
                      <div className="login-toggle-mode">
                        ...
                        >
                          {isRegister 
                            ...
                            : (isEnglish ? 'New user? Register' : 'নতুন ব্যবহারকারী? রেজিস্ট্রেশন করুন')
                          }
                        </button>
                      </div>
                    </form>
                    ...
                    <form onSubmit={handleSendEmailVerification} className="login-form">
                      <div className="login-input-group">
                        <label>
                          {isEnglish ? 'Email Address' : 'ইমেইল ঠিকানা'}
                        </label>
                        <input
                          type="email"
